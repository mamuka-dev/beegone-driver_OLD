package com.gotaxi.driver.utils;
...
public class ApplyFont {
    ...
    public static String FONT_TYPEFACE = "Roboto_Regular.ttf";
    public static String FONT_SEMIBOLDTYPEFACE = "Roboto_Medium.ttf";
    public static String FONT_TYPEFACE_Bold = "Roboto_Bold.ttf";
    public static String FONT_TYPEFACE_LIGHT = "Roboto_Light.ttf";
