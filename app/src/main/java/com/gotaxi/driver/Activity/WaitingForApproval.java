...
public class WaitingForApproval extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resubmitDocBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(WaitingForApproval.this, UploadDocumentActivity.class));
            }
        });
    ...
    public void paypending(View view) {
        startActivity(new Intent(WaitingForApproval.this, WalletActivity.class));
    }
}
