...
public class ShowProfile extends AppCompatActivity {
    ...
    public void findViewByIdandInitialization() {
        ...
        Picasso.get().load(user.getImg()).memoryPolicy(MemoryPolicy.NO_CACHE).placeholder(R.drawable.img_profile_placehodler).error(R.drawable.img_profile_placehodler).into(profile_Image);
    }
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URLHelper.USER_PROFILE_API+"?user_id="+strUserId,
            ...
            public void onResponse(JSONObject jsonProviderObj) {
                try {
                    ...
                    Picasso.with(context).load(URLHelper.base + jsonProviderObj.optString("picture")).memoryPolicy(MemoryPolicy.NO_CACHE).placeholder(R.drawable.img_profile_placehodler).error(R.drawable.img_profile_placehodler).into(profile_Image);
